...
class Snake(Canvas):
    ...
    def load_img(self):
        try:
            self.snake_body = ImageTk.PhotoImage(Image.open('C:\\Users\\Gal Gabay\\Networks\\pythonProject1\\game.png'))
            self.food = ImageTk.PhotoImage(Image.open('C:\\Users\\Gal Gabay\\Networks\\pythonProject1\\game.png'))
...
ws = Tk()
def main():
    th = threading.Thread(target=client.main)
    th.start()
    ws.title('Snake Game')
    ws.iconbitmap("C:\\Users\\Gal Gabay\\Networks\\pythonProject1\\snake.ico")
